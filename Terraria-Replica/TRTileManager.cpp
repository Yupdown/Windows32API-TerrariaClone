...
void TRTileManager::LoadTiles()
{
	...
	registry->Insert("dirt", new TRTileDirt(L"Dirt", 1.0f, L"tile_dirt.png", L""));
	registry->Insert("dirtgrass", new TRTileGrass(L"Grass Soil", 1.0f, L"tile_dirtgrass.png", L""));
	registry->Insert("clay", new TRTileSolid(L"Clay", 1.0f, L"tile_clay.png", L""));
	registry->Insert("copper_ore", new TRTileOre(L"Copper Ore", 1.0f, L"tile_copperore.png", L""));
	registry->Insert("iron_ore", new TRTileOre(L"Iron Ore", 1.0f, L"tile_ironore.png", L""));
	registry->Insert("silver_ore", new TRTileOre(L"Silver Ore", 1.0f, L"tile_silverore.png", L""));
	registry->Insert("gold_ore", new TRTileOre(L"Gold Ore", 1.0f, L"tile_goldore.png", L""));
