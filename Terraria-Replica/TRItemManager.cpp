...
void TRItemManager::LoadItems()
{
	...
	registry->Insert(L"tile_bricks_stone", new TRItemTile(L"Stone Bricks", L"Item_14.png", L"bricks_stone"));
	registry->Insert(L"tile_bricks_clay", new TRItemTile(L"Bricks", L"Item_13.png", L"bricks_clay"));
	registry->Insert(L"wall_cobblestone", new TRItemTileWall(L"Cobblestone Wall", L"Item_13.png", L"cobblestone"));
	registry->Insert(L"wall_dirt", new TRItemTileWall(L"Dirt Wall", L"Item_13.png", L"dirt"));
	registry->Insert(L"wall_planks_wood", new TRItemTileWall(L"Wooden Planks Wall", L"Item_13.png", L"planks_wood"));
	registry->Insert(L"wall_bricks_stone", new TRItemTileWall(L"Stone Bricks Wall", L"Item_13.png", L"bricks_stone"));
	registry->Insert(L"wall_bricks_clay", new TRItemTileWall(L"Bricks Wall", L"Item_13.png", L"bricks_clay"));
