...
CScene_Start::CScene_Start()
{
	...
	float ground_level = 48 * PIXELS_PER_TILE;
	...
	m_vecLayer.emplace_back(CLayer::CreateLayer(L"Background_1.png",Vec2{ 0, ground_level },vRes ,Vec2{ vRes.x,vRes.y * 10.f }, 10, 0.4f));
	m_vecLayer.emplace_back(CLayer::CreateLayer(L"Background_2.png",Vec2{ 0, ground_level },vRes ,Vec2{ vRes.x,vRes.y * 10.f }, 10,0.6f));
	m_vecLayer.emplace_back(CLayer::CreateLayer(L"Background_3.png",Vec2{ 0, ground_level },vRes ,Vec2{ vRes.x,vRes.y * 10.f }, 10,0.8f));
	m_vecLayer.emplace_back(CLayer::CreateLayer(L"Background_4.png",Vec2{ 0, ground_level },vRes ,Vec2{ vRes.x,vRes.y * 10.f }, 10,1.f));
